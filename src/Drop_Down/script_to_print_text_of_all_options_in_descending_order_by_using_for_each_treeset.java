...
public class script_to_print_text_of_all_options_in_descending_order_by_using_for_each_treeset 
{
	public static void main(String [] args) throws InterruptedException
	{
		...
		//Array Declaration and it sorts data in reverse order(bottom to top)
