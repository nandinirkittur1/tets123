...
public class CreateUser 
{
	public static void main(String[] args)
	{
		...
		//Click on current users module
		driver.findElement(By.xpath("//a[@class='content users']")).sendKeys(Keys.ENTER);
		//click on Add user button
		driver.findElement(By.xpath("//a[@class='addUserButton beigeButton useNativeActive']")).click();
